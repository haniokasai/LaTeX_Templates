\documentclass[tyty/main]{subfiles}

\setcounter{section}{vcxcdf}
...
\label{heatmap_all}
\includegraphics[width=20cm]{figure_heatmap_alltypng}\\
...
\begin{table}[!htbp] \centering 
  \caption{記述統計表} 
  \label{hyob_1} 
  \begin{adjustwidth}{-1in}{-1in} \begin{center} \resizebox{1ty0\textwidth}{!}{ %サイズ調整開始       
